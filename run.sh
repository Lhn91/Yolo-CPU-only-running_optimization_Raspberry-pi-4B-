...
# Default: FP32 / Custom model
PARAM="${SCRIPT_DIR}/models/721_M4_BaoLong.ncnn.param"
BIN="${SCRIPT_DIR}/models/721_M4_BaoLong.ncnn.bin"

# INT8 model paths
PARAM_INT8="${SCRIPT_DIR}/models/model.int8.param"
BIN_INT8="${SCRIPT_DIR}/models/model.int8.bin"

# FP16 model paths
PARAM_FP16="${SCRIPT_DIR}/models/model.fp16.param"
BIN_FP16="${SCRIPT_DIR}/models/model.fp16.bin"
...
# Update paths if custom model is provided
if [ -n "$MODEL_NAME" ]; then
    PARAM="${SCRIPT_DIR}/models/${MODEL_NAME}.param"
    BIN="${SCRIPT_DIR}/models/${MODEL_NAME}.bin"
    PARAM_INT8="${SCRIPT_DIR}/models/${MODEL_NAME}.int8.param"
