#!/bin/bash
# Script để khởi chạy nhanh model 26n_70k_80epoch
# Nhớ cấp quyền thực thi trên Pi: chmod +x run_26n_70k_80epoch.sh
...
echo "Kich hoat model 26n_70k_80epoch qua Webcam + Framebuffer + INT8..."
# Truyền đúng tên base của model (bao gồm cả .ncnn để đúng với file .ncnn.param)
./run.sh cam fb int8 model "26n_70k_80epoch"
